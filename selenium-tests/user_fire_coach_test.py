...
if __name__ == "__main__":
    ...
    flog = os.path.join(".nyc_output", "fire_report.json")
    ...
    subprocess.run(["npx", "nyc", "report",
     ...
     "-n", "src/components/LeaveReview.jsx",
     "-n", "src/components/ReviewCard.jsx",
     "-n", "src/components/ReportModal.jsx",
    "-n", "src/components/FireModal.jsx"], check=True, shell=True)
